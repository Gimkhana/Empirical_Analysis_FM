...
Our investment universe comprises a selection of twenty high-performing
and influential companies, primarily from the technology sector. These
...
-   **AAPL (Apple Inc.)**: A leader in consumer electronics, software,
    and services.
-   **MSFT (Microsoft Corporation)**: A global leader in software,
    services, devices, and solutions.
-   **GOOGL (Alphabet Inc.)**: The parent company of Google, known for
    its dominant search engine and a wide array of internet services and
    products.
-   **AMZN (Amazon.com, Inc.)**: A powerhouse in e-commerce, cloud
    computing, and artificial intelligence.
-   **TSLA (Tesla, Inc.)**: An innovative company in electric vehicles,
    energy storage, and solar products.
-   **NVDA (NVIDIA Corporation)**: A pioneer in graphics processing
    units (GPUs) for gaming and professional markets.
-   **PYPL (PayPal Holdings, Inc.)**: A leading technology platform and
    digital payments company.
-   **CMCSA (Comcast Corporation)**: A global media and technology
    company with two primary businesses, Comcast Cable and NBCUniversal.
-   **ADBE (Adobe Inc.)**: A leader in multimedia and creativity
    software products.
-   **ASML (ASML Holding N.V.)**: A leading supplier to the
    semiconductor industry.

These companies are selected not only for their individual performance
but also for their collective ability to provide broad exposure to
various subsectors within technology and adjacent industries. They
encompass hardware, software, services, semiconductor, e-commerce,
digital payments, media, and entertainment sectors.

-   **CSCO (Cisco Systems, Inc.)**: A multinational technology
    conglomerate that develops, manufactures, and sells networking
    hardware, software, and other high-technology services and products.
-   **PEP (PepsiCo, Inc.)**: A multinational food, snack, and beverage
    corporation.
-   **AVGO (Broadcom Inc.)**: Designs, develops, and supplies a broad
    range of semiconductor and infrastructure software solutions.
-   **TMUS (T-Mobile US, Inc.)**: A leading wireless network operator.
-   **INTC (Intel Corporation)**: One of the world's largest and highest
    valued semiconductor chip manufacturers.
-   **TXN (Texas Instruments Incorporated)**: Designs and manufactures
    semiconductors and various integrated circuits.
-   **AMGN (Amgen Inc.)**: Amgen is a leading biotechnology company that
    develops and manufactures drugs for a variety of diseases, including
    cancer, heart disease, and arthritis.
-   **NFLX (Netflix, Inc.)**: A streaming service that offers a variety
    of TV series, documentaries, and feature films across a wide variety
    of genres and languages.
-   **SBUX (Starbucks Corporation)**: A multinational chain of
    coffeehouses and roastery reserves.
-   **AMAT (Applied Materials, Inc.)** is a leading provider of
    materials engineering solutions used to produce new chip and
    advanced display.

Overall, the investment universe selected includes a mix of large-cap US
technology stocks (AAPL, MSFT, GOOGL, AMZN, TSLA, NVDA, PYPL, CMCSA,
ADBE, ASML), consumer staples stocks (PEP), semiconductor stocks (AVGO,
INTC, TXN), healthcare stocks (AMGN), and consumer discretionary stocks
(NFLX, SBUX, AMAT).
...
-   **AAPL (Apple)**: The company has a strong track record of
    innovation. The company is expected to benefit from the continued
    growth of the smartphone market and the launch of new products and
    services.

-   **MSFT (Microsoft)**: The company has a diversified business model.
    They are expected to benefit from the growth of cloud computing and
    other enterprise software markets.

-   **GOOGL (Alphabet)**: The company is also a leader in online
    advertising and cloud computing. Alphabet is expected to benefit
    from the continued growth of the digital economy.

-   **AMZN (Amazon)**: The company is also a leader in cloud computing
    and other e-commerce businesses. Amazon is expected to benefit from
    the continued growth of online shopping and cloud computing.

-   **TSLA (Tesla)**: The company is expected to benefit from the
    growing demand for electric vehicles and the transition to clean
    energy.

-   **NVDA (Nvidia)**: GPUs are used in a variety of applications,
    including gaming, artificial intelligence, and data center
    computing. Nvidia is expected to benefit from the growth of these
    markets.

-   **PYPL (PayPal)**: The company is expected to benefit from the
    growth of e-commerce and digital payments.

-   **CMCSA (Comcast)**: The company is expected to benefit from the
    continued growth of broadband internet and the rollout of new
    streaming services.

-   **ADBE (Adobe)**: The company's products are used by a wide range of
    customers, including individuals, small businesses, and large
    corporations. Adobe is expected to benefit from the continued growth
    of the digital economy and the demand for creative software.

-   **ASML (ASML Holding)**: Lithography systems are used to create the
    chips that are used in a wide range of electronic devices. ASML is
    expected to benefit from the growth of the semiconductor industry.

-   **CSCO (Cisco Systems)**: The company's products are used by
    businesses of all sizes to connect their networks and devices. Cisco
    is expected to benefit from the growth of digital transformation and
    the rollout of new technologies, such as 5G.

-   **PEP (PepsiCo)**: The company has a strong portfolio of brands,
    including Pepsi, Doritos, and Frito-Lay. PepsiCo is expected to
    benefit from the continued growth of the consumer packaged goods
    industry.

-   **AVGO (Broadcom)**: The company's products are used in a range of
    electronic devices, including smartphones, computers, and networking
    equipment. Broadcom is expected to benefit from the growth of the
    semiconductor industry and the rollout of new technologies, such as
    5G.

-   **TMUS (T-Mobile US)**: The company is expected to benefit from the
    growth of the wireless data market and the rollout of 5G services.

-   **INTC (Intel)**: The company is known for its microprocessors,
    which are used in a wide range of computers. Intel is also investing
    in new growth areas, such as data center computing and artificial
    intelligence. Intel is expected to benefit from the continued growth
    of the semiconductor industry.

-   **TXN (Texas Instruments)**: The company's products are used in a
    wide range of electronic devices, including smartphones, computers,
    and industrial equipment. Texas Instruments is expected to benefit
    from the continued growth of the semiconductor industry.

-   **AMGN (Amgen)**: The company develops and manufactures a wide range
    of drugs, including treatments for cancer, heart disease, and other
    chronic diseases. Amgen is expected to benefit from the growth of
    the biotechnology industry and the aging population. The global
    population is aging, and this is creating demand for new drugs to
    treat the diseases that are associated with aging. Amgen's products
    are well-positioned to benefit from this trend. The biotechnology
    industry is one of the fastest-growing industries in the world.
    Amgen is a leading player in this industry, and it is
    well-positioned to benefit from its continued growth. Also, Amgen is
    heavily invested in research and development, and this is expected
    to help the company develop new and innovative drugs in the future.

-   **NFLX (Netflix)**: The company offers a wide range of TV shows and
    movies to subscribers on demand. Netflix is expected to benefit from
    the continued growth of the streaming entertainment industry. The
    streaming entertainment market is expected to continue to grow in
    the coming years, as more and more consumers shift away from
    traditional cable and satellite TV. On the same line, Netflix is
    investing heavily in original content production, and this is
    expected to help the company attract and retain subscribers.

-   **SBUX (Starbucks)**: The company has a strong brand and a loyal
    customer base. Starbucks is expected to benefit from the economic
    rebound of the US economy. Starbucks is expected to benefit from a
    number of trends. The global coffee market is expected to continue
    to grow in the coming years, driven by rising incomes and increasing
    urbanization in emerging markets. Also, China is one of Starbucks'
    largest and fastest-growing markets. The company is investing
    heavily in expanding its store network and developing new products
    for the Chinese market.

-   **AMAT (Applied Materials, Inc.):** The company's products
    are used by semiconductor manufacturers around the world to produce
    the most advanced chips and displays. Applied Materials is expected
    to benefit from a number of trends, including growth in the
    semiconductor industry which is expected to continue to grow in the
    coming years, driven by demand for new chips from a variety of
    industries, including consumer electronics, automotive, and data
    center.Also, the display market is also expected to grow in the
    coming years, driven by demand for new and larger displays for
    smartphones, TVs, and other electronic devices. Applied Materials is
    a leading provider of materials engineering solutions for the
    display industry.
...
```{r Cumulative return plot, echo=FALSE}
...
**Asset class: Equities (VTI)**

VTI provides broad exposure to the global stock market, which is
expected to benefit from economic growth.

**Asset class: Emerging market equities (EMGF)**

EMGF provides exposure to emerging markets with favorable exposure to
value, quality, momentum, and size factors. Emerging markets have the
potential for higher growth than developed markets, but they also come
with more risk. EMGF mitigates some of the risk by investing in
companies with favorable exposure to specific factors.

**Asset class: Government bonds (IEF)**

IEF provides exposure to intermediate-term government bonds, which are
typically considered to be low-risk investments. This can provide
stability to a portfolio in times of economic uncertainty.

**Asset class: Commodities (DBC)**

DBC provides exposure to a basket of commodities, which can be a good
way to diversify a portfolio and hedge against inflation. However, it is
important to note that commodities are volatile investments.

**Asset class: Precious metals (GLD)**

GLD provides exposure to gold, which is a traditional safe haven asset
that can provide protection against inflation and market volatility.
...
```{r Cumulative return plot 2, echo=FALSE}
...
```{r Correlation multi-asset portfolio , echo=FALSE}
...
-   **International equities (TICKER: VTI):** Strongly overweight (5%)

-   **Emerging Markets** **(TICKER: EMGF):** Relatively overweight (1%)

-   **US short term maturity bond** **(TICKER: IEF):** Strongly
    overweight (5%)

-   **Commodities** **(TICKER: DBC):** Neutral (0%)

-   **Gold** **(TICKER: GLD):** Relatively underweight (-2%)
...
We have increased our allocation to international equities from 17.54%
to 18.4%. This remains overweight relative to the neutral stance of
BlackRock and GSAM, but it is now more in line with the overweight
stance of JPMAM.

**Emerging Markets**

We have also increased our allocation to emerging markets from 5.7% to
5.9%. This remains a relatively overweight position, given that
BlackRock and JPMAM are neutral on emerging markets, while GSAM is
underweight. However, we have carefully considered the risks associated
with emerging markets, such as currency fluctuations and political
instability, and have determined that this level of overweight exposure
is appropriate for our risk tolerance and investment goals.

**US Short-Term Treasuries**

We have significantly increased our allocation to US short-term
treasuries from 88.91% to 92.4%. This is now a strongly overweight
position, consistent with the bullish views of BlackRock and GSAM. We
believe that US short-term treasuries offer attractive yields and are a
good way to preserve capital in the current uncertain economic
environment.

**Commodities**

We have increased our allocation to commodities from 0.06% to 1.9%. This
is now a neutral position, but it is still below the overweight
positions of all three asset managers. We have taken into account the
cyclical nature of commodity prices and the potential for downside risk,
and have determined that this level of exposure is appropriate for our
overall portfolio.

**Gold**

We have significantly reduced our allocation to gold from -12.83% to
-18.22%. This is now a strongly underweight position, contrary to the
overweight positions of all three asset managers. We believe that gold's
safe-haven status is overvalued and that it is not a good investment for
...
```{r Tatical allocation Omega_mixed plot, echo=FALSE}
...
#### 3.2.1.2 Equity price simulation
...
#### 3.2.1.3 Strategies implementation
...
plot_results <- function(results, title) {
  ...
  ggplot(df, aes(x = t, y = Value, color = Type)) +
    ...
    scale_color_brewer(palette = "Set1") +  # More formal color palette
    theme_bw() +  # A theme with a white background often used in publications
    theme(
      ...
      legend.box.background = element_rect(color = "black", size = 0.5),  # Encloses the legend in a box
      panel.grid.major = element_line(size = 0.5, linetype = 'solid', color = "white"),  # Adjust grid lines
      panel.grid.minor = element_blank(),  # Removes minor grid lines for a cleaner look
      plot.margin = margin(5.5, 5.5, 5.5, 5.5)  # Adjust plot margins
    )
}
```
...
###Alternative way of computing Monte Carlo simulation (alternative R script)

# library(tibble) #to help us construct data frames coupled with 
# 
# # Parameters
...
# print(summary_cppi)
# 
# #Return and volatility calculaiton for each variable
# 
...
#   Mean_Return = c(mean_return_equity, mean_return_obpi, mean_return_cppi),
...
```{r Monte Carlo plot 4 script, echo=FALSE}
...
```{r Monte Carlo plot 5 script, echo=FALSE}
# Histogram for final OBPI strategy values
...
```{r Monte Carlo plot 6 script, echo=FALSE}
# Histogram for final CPPI strategy values
