...
-   **AMAT (Applied Materials, Inc.):** The company's products are used
    by semiconductor manufacturers around the world to produce the most
    advanced chips and displays. Applied Materials is expected to
    benefit from a number of trends, including growth in the
...
```{r GMV plot , fig.cap="GMV portfolio weights. Each represent a stock weight (from left to right: AAPL, MSFT, GOOGL, AMZN, TSLA, NVDA, PYPL, CMCSA, ADBE, ASML, CSCO, PEP, AVGO, TMUS, INTC, TXN, AMGN, NFLX, SBUX, AMAT.", echo=FALSE, fig.pos='H'}
...
```{r PCA three factor model, fig.cap="PCA portfolio weights. Each bar represent a stock weight (from left to right: AAPL, MSFT, GOOGL, AMZN, TSLA, NVDA, PYPL, CMCSA, ADBE, ASML, CSCO, PEP, AVGO, TMUS, INTC, TXN, AMGN, NFLX, SBUX, AMAT.", echo=FALSE, fig.pos='H'}
#PCA one factor
...
```{r Subsample 2 multi-asset portfolio, fig.cap="Structure of the first subsample.", echo=FALSE, fig.pos='H'}
